 ...
 *
 *    Description:  a simple implementation of threadpool in C.  
 *
 *        Version:  1.0
 *        Created:  06/26/16 17:22:10
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME Kang Li, 
 *   Organization:  nelist@iie
 *
 * =====================================================================================
 */
#include <stdio.h>
...
int pool_destory()
{
    ...
    for(i=0;i<pool->max_thread_num;i++)
        pthread_join(pool->threadid[i],NULL);//???这个函数不是阻塞的么
    free(pool->threadid);
